function func_wakerollup_1_TELE(dt,now_index,vortices_CELL,gamma_mat,wake_vortex_ring_now,LE_wake_vortex_ring_now)
...
%% Loop for velocity of NEAR-WAKE vortex rings
        r = 1;
...
%% Loop for velocity of NEAR-WAKE LEADING-EDGE vortex rings
  ...
  r = 1;
        ...
        dX_1 = (u1+u1w+LE_u1w)*dt;
        dX_2 = (u2+u2w+LE_u2w)*dt;
        dX_3 = (u3+u3w+LE_u3w)*dt;
        dX_4 = (u4+u4w+LE_u4w)*dt;
        dY_1 = (v1+v1w+LE_v1w)*dt;
        dY_2 = (v2+v2w+LE_v2w)*dt;
        dY_3 = (v3+v3w+LE_v3w)*dt;
        dY_4 = (v4+v4w+LE_v4w)*dt;
        dZ_1 = (w1+w1w+LE_w1w)*dt;
        dZ_2 = (w2+w2w+LE_w2w)*dt;
        dZ_3 = (w3+w3w+LE_w3w)*dt;
        dZ_4 = (w4+w4w+LE_w4w)*dt;
