...
for j = 1:n_cols
    ...
    LE_FW_wake_vortons{now_index-2,j} = vorton;
    
    LE_FW_wake_vortons{now_index-2,j}.X = (vortex_rings{now_index-2,j}.X_4+vortex_rings{now_index-2,j}.X_3)/2;
    LE_FW_wake_vortons{now_index-2,j}.Y = (vortex_rings{now_index-2,j}.Y_4+vortex_rings{now_index-2,j}.Y_3)/2;
    LE_FW_wake_vortons{now_index-2,j}.Z = (vortex_rings{now_index-2,j}.Z_4+vortex_rings{now_index-2,j}.Z_3)/2;
 ...
 %  0.5*(vortex_rings{now_index-2,j}.GAMMA).*t4_kj
   ...
   LE_FW_wake_vortons{now_index-2,j}.A_X = A_vect(1);
   LE_FW_wake_vortons{now_index-2,j}.A_Y = A_vect(2);
   LE_FW_wake_vortons{now_index-2,j}.A_Z = A_vect(3);
