function func_wakerollup_VORTONS_PARALL(dt,now_index,vortices_CELL,gamma_mat,wake_vortex_ring_now,FW_wake_vortons_now,sig)

global NW_wake_vortex_rings FW_wake_vortons n_cols n_rows
...
%% PAY ATTENTION THERE IS NO LEADING EDGE VORTICES INDUCTION NOW        
        ...
        dX_1 = (u1+u1w+u1w_v+u1w_LE+u1_w_NWFW_tot)*dt;
        dX_2 = (u2+u2w+u2w_v+u2w_LE+u2_w_NWFW_tot)*dt;
        dX_3 = (u3+u3w+u3w_v+u3w_LE+u3_w_NWFW_tot)*dt;
        dX_4 = (u4+u4w+u4w_v+u4w_LE+u4_w_NWFW_tot)*dt;
        dY_1 = (v1+v1w+v1w_v+v1w_LE+v1_w_NWFW_tot)*dt;
        dY_2 = (v2+v2w+v2w_v+v2w_LE+v2_w_NWFW_tot)*dt;
        dY_3 = (v3+v3w+v3w_v+v3w_LE+v3_w_NWFW_tot)*dt;
        dY_4 = (v4+v4w+v4w_v+v4w_LE+v4_w_NWFW_tot)*dt;
        dZ_1 = (w1+w1w+w1w_v+w1w_LE+w1_w_NWFW_tot)*dt;
        dZ_2 = (w2+w2w+w2w_v+w2w_LE+w2_w_NWFW_tot)*dt;
        dZ_3 = (w3+w3w+w3w_v+w3w_LE+w3_w_NWFW_tot)*dt;
        dZ_4 = (w4+w4w+w4w_v+w4w_LE+w4_w_NWFW_tot)*dt;
...
FW_wake_vortons_buffer = cell(1,cols*(now_index-2));
FW_wake_vortons_now_buffer = cell(1,cols*(now_index-2));
...
%% VORTONS UPDATING        
        ...
        dA_X = (AX_w+AX_wvr+AX_v+AX_w_NWFW_tot)*dt;
        dA_Y = (AY_w+AY_wvr+AY_v+AY_w_NWFW_tot)*dt;
        dA_Z = (AZ_w+AZ_wvr+AZ_v+AZ_w_NWFW_tot)*dt;
        ...
        dX_1 = (u1+u1w+u1w_v+u1_w_NWFW_tot)*dt;
        dY_1 = (v1+v1w+v1w_v+v1_w_NWFW_tot)*dt;
        dZ_1 = (w1+w1w+w1w_v+w1_w_NWFW_tot)*dt;
